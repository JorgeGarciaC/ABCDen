...
gf <- list(gene_flow(from = den, to = chb, start = 43e3, end = 42e3, rate = 0.002),
           gene_flow(from = eur, to = E_afr, start = 13e3, end = 12e3, rate = 0.12), # BACK TO AFRICA
...
extension <- substitute_values(
  extension_template,
  s_den = s_den, s_nea = s_nea, s_chb = s_chb, s_eur = s_eur, 
